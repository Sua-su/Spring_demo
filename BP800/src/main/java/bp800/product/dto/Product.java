...
public class Product {
	...
	public Product(int id, String code, String category, String name,
			String country, int price, String alcohol, String content,
			int like, int dislike, String imgFileName) {
		super();
		this.id = id;
		this.code = code;
